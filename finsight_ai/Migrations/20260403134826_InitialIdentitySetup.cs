        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedReturn = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BusinessDecisions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BusinessDecisions_CompanyProfiles_CompanyProfileId",
                        column: x => x.CompanyProfileId,
                        principalTable: "CompanyProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NetCashFlow = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    CompanyProfileId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CashFlowSnapshots", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CashFlowSnapshots_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CashFlowSnapshots_CompanyProfiles_CompanyProfileId",
                        column: x => x.CompanyProfileId,
                        principalTable: "CompanyProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FinancialRecords_CompanyProfiles_CompanyProfileId",
                        column: x => x.CompanyProfileId,
                        principalTable: "CompanyProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BusinessDecisions_CompanyProfileId",
                table: "BusinessDecisions",
                column: "CompanyProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_BusinessDecisions_UserId",
                table: "BusinessDecisions",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_CashFlowSnapshots_CompanyProfileId",
                table: "CashFlowSnapshots",
                column: "CompanyProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_CashFlowSnapshots_UserId",
                table: "CashFlowSnapshots",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialRecords_CompanyProfileId",
